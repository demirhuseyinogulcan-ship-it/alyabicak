            ...
            <div className="flex gap-2">
              ...
              {siteConfig.social.wechat && (
                <a 
                  ...
                  className="w-8 h-8 bg-steel-800 hover:bg-green-600 rounded-full flex items-center justify-center transition-colors group relative"
                  aria-label="WeChat"
                >
                  ...
                  <span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-steel-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    {siteConfig.social.wechat}
                  </span>
                </a>
              )}
