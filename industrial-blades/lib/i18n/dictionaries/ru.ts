...
const ru = {
  ...
  // Blade Engineer Tool
  bladeEngineer: {
    pageTitle: 'Blade Engineer - Инструмент технического чертежа',
    pageSubtitle: 'Создавайте технические чертежи по стандартам ISO для промышленных лезвий и ножей',
    step1: 'Геометрия',
    step2: 'Размеры',
    step3: 'Профиль кромки',
    step4: 'Предпросмотр',
    step5: 'Запрос',
    selectGeometry: 'Выберите геометрию лезвия',
    dimensions: 'Размеры',
    edge: 'Кромка',
    mounting: 'Крепление',
    preview: 'Предпросмотр и экспорт',
    edgeType: 'Тип кромки',
    toothPitch: 'Шаг зуба',
    toothDepth: 'Глубина зуба',
    toothAngle: 'Угол зуба',
    applySides: 'Применить к сторонам',
    exportPdf: 'Скачать PDF (Чертеж A4)',
    ...
    toggleGrid: 'Сетка',
    toggleDimensions: 'Размеры',
    toggleCenterLines: 'Осевые линии',
    back: 'Назад',
    next: 'Далее',
    material: 'Материал',
    hardness: 'Твёрдость',
    coating: 'Покрытие',
    notes: 'Примечания',
    bladeName: 'Название лезвия',
    circularLabel: 'Круглое / Дисковое',
    circularDesc: 'Дисковые ножи, ротационные резаки',
    rectangularLabel: 'Прямоугольное / Прямое',
    rectangularDesc: 'Гильотина, гранулятор, шредер, ножи лог-пилы',
    oblongLabel: 'Продолговатое / Лезвие',
    oblongDesc: '3-отверстия, щелевые, инжекторные лезвия',
    trapezoidLabel: 'Трапециевидное',
    trapezoidDesc: 'Универсальные, упаковочные лезвия',
    triangularLabel: 'Треугольное / Остроконечное',
    triangularDesc: 'Плоттер, ЧПУ, скальпель, ремесленные лезвия',
    hookLabel: 'Крючок / Вогнутое',
    hookDesc: 'Крючковые лезвия, снятие оболочки',
    customLabel: 'Произвольный профиль',
    customDesc: 'Пятиугольник, звезда, термоформ',
    outerDiameter: 'Наружный диаметр',
    innerDiameter: 'Внутренний диаметр',
    thickness: 'Толщина',
    bevelAngle: 'Угол заточки',
    bevelType: 'Тип заточки',
    dishAngle: 'Угол тарелки',
    length: 'Длина',
    width: 'Ширина',
    cornerRadius: 'Радиус угла',
    holeCount: 'Кол-во отверстий',
    holeSpacing: 'Расстояние между отверстиями',
    holeDiameter: 'Диаметр отверстия',
    hasSlot: 'Есть паз',
    cornerShape: 'Форма угла',
    topWidth: 'Верхняя ширина',
    bottomWidth: 'Нижняя ширина',
    height: 'Высота',
    notchCount: 'Кол-во пазов',
    baseWidth: 'Ширина основания',
    tipAngle: 'Угол острия',
    shankType: 'Тип хвостовика',
    shankDiameter: 'Диаметр хвостовика',
    overallLength: 'Общая длина',
    overallWidth: 'Общая ширина',
    hookDepth: 'Глубина крюка',
    curveRadius: 'Радиус кривизны',
    hasBackEdge: 'Задняя кромка заточена',
    mountingType: 'Тип крепления',
    boundingWidth: 'Ширина габарита',
    boundingHeight: 'Высота габарита',
    sideCount: 'Кол-во сторон',
    circumscribedDiameter: 'Описанный диаметр',
    centerHoleDiameter: 'Диаметр центрального отверстия',
    bevelNone: 'Без заточки',
    bevelSingle: 'Одностороняя',
    bevelDouble: 'Двусторонняя',
    bevelHollow: 'Вогнутая заточка',
    noHoles: 'Без отверстий',
    twoHoles: '2 отверстия',
    threeHoles: '3 отверстия',
    cornerSquare: 'Прямой угол',
    cornerRounded: 'Скруглённый угол',
    cornerAngled: 'Фаска',
    noNotches: 'Без пазов',
    oneNotch: '1 паз',
    twoNotches: '2 паза',
    threeNotches: '3 паза',
    shankNone: 'Без хвостовика',
    shankRound: 'Круглый хвостовик',
    shankFlat: 'Плоский хвостовик',
    mountNotch: 'Пазовое крепление',
    mountTang: 'Хвостовое крепление',
    mountHole: 'Болтовое крепление',
    edgePlain: 'Гладкая (стандарт)',
    edgeSerrated: 'Зубчатая (V-зуб)',
    edgeWavy: 'Волнистая',
    edgePerforating: 'Перфорирующая',
    edgeScalloped: 'Фестончатая',
    edgeZigzag: 'Зигзаг',
    quoteTitle: 'Запрос коммерческого предложения',
    quoteName: 'ФИО',
    quoteEmail: 'Эл. почта',
    quotePhone: 'Телефон',
    quoteCompany: 'Компания',
    quoteQuantity: 'Количество',
    quoteMessage: 'Ваше сообщение',
