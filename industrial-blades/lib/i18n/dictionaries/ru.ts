...
const ru = {
  // Meta & SEO
  meta: {
    title: 'Alya Blade | Промышленные Режущие Решения',
    description: 'Ведущий турецкий поставщик промышленных лезвий и бритв. Более 30 лет опыта в промышленных лезвиях, машинных ножах и защитных резаках.',
    keywords: 'промышленное лезвие, промышленная бритва, машинный нож, режущий инструмент, поставщик лезвий',
  },
