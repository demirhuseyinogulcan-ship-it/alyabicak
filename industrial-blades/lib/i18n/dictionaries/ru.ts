...
const ru = {
  ...
  faq: {
    ...
    subtitle: 'Здесь вы найдёте ответы на самые распространённые вопросы о промышленных лезвиях и нашем сервисе',
    searchPlaceholder: 'Поиск вопросов...',
    noResults: 'Не найдено вопросов по вашему запросу.',
    categories: {
      all: 'Все',
      general: 'Общие',
      products: 'Продукция',
    ...
    items: [
      {
        question: 'Какие преимущества у промышленных лезвий?',
        answer: 'Промышленные лезвия предлагают высокую точность резки, долгий срок службы и снижение производственных затрат. Лезвия шеффилдского качества обеспечивают превосходные результаты резки.',
        category: 'general',
      },
      {
        question: 'Каков срок доставки?',
        answer: 'Стандартные товары доставляются в течение 3-5 рабочих дней. Для специальных заказов свяжитесь с нами.',
        category: 'shipping',
      },
      {
        question: 'Предоставляете ли вы техническую поддержку?',
        answer: 'Да, мы предоставляем техническую поддержку всем нашим клиентам. Наша команда экспертов поможет вам выбрать правильное лезвие и оптимизировать резку.',
        category: 'technical',
      },
      {
        question: 'Какова ваша политика возврата?',
        answer: 'Неоткрытые товары могут быть возвращены в течение 14 дней. Свяжитесь с нашей службой поддержки для начала процесса возврата.',
        category: 'orders',
      },
      {
        question: 'Осуществляете ли вы международную доставку?',
        answer: 'Да, мы осуществляем доставку более чем в 35 стран мира. Стоимость и сроки доставки зависят от места назначения.',
        category: 'shipping',
      },
    ],
    contact: {
      title: 'Не нашли ответ?',
      description: 'Если вы не нашли ответ на свой вопрос, свяжитесь с нами.',
  ...
  privacy: {
    ...
    subtitle: 'Информация о том, как мы собираем, используем и защищаем ваши персональные данные',
    lastUpdated: 'Последнее обновление',
    sections: {
      intro: {
        title: 'Введение',
        content: 'Настоящая Политика конфиденциальности описывает, как мы собираем, используем и защищаем вашу личную информацию при использовании нашего веб-сайта и услуг.',
      },
      dataCollection: {
        title: 'Сбор Данных',
        content: 'Мы можем собирать следующие типы информации: контактные данные (имя, email, телефон), информацию о компании, данные об использовании веб-сайта.',
      },
      dataUsage: {
        title: 'Использование Данных',
        content: 'Собранные данные используются для: обработки запросов и заказов, улучшения наших услуг, связи с вами, маркетинговых коммуникаций (с вашего согласия).',
      },
      dataProtection: {
        title: 'Защита Данных',
        content: 'Мы применяем соответствующие технические и организационные меры для защиты ваших персональных данных от несанкционированного доступа, изменения или уничтожения.',
      },
      rights: {
        title: 'Ваши Права',
        content: 'Вы имеете право на доступ, исправление или удаление ваших персональных данных. Свяжитесь с нами для реализации этих прав.',
      },
      contact: {
        title: 'Контакты',
        content: 'По вопросам конфиденциальности свяжитесь с нами по email или телефону.',
      },
    },
  },
  ...
  cookiePolicy: {
    ...
    subtitle: 'Информация об использовании cookie на нашем веб-сайте',
    lastUpdated: 'Последнее обновление',
    sections: {
      what: {
        title: 'Что такое Cookie?',
        content: 'Cookie - это небольшие текстовые файлы, которые сохраняются на вашем устройстве при посещении веб-сайта. Они помогают улучшить ваш опыт использования сайта.',
      },
      types: {
        title: 'Типы Cookie',
        necessary: {
          title: 'Необходимые Cookie',
          content: 'Эти cookie необходимы для правильной работы веб-сайта. Без них некоторые функции могут быть недоступны.',
        },
        analytics: {
          title: 'Аналитические Cookie',
          content: 'Эти cookie помогают нам понять, как посетители взаимодействуют с сайтом, собирая анонимную информацию.',
        },
        functional: {
          title: 'Функциональные Cookie',
          content: 'Эти cookie запоминают ваши предпочтения, такие как язык или регион.',
        },
      },
      management: {
        title: 'Управление Cookie',
        content: 'Вы можете управлять или удалять cookie через настройки вашего браузера. Обратите внимание, что отключение некоторых cookie может повлиять на функциональность сайта.',
      },
    },
  },
};
