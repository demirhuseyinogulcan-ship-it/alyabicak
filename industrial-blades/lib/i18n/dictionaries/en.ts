...
const en = {
  ...
  bladeConfigurator: {
    pageTitle: 'Blade Configurator',
    pageSubtitle: 'Create a blade specification, download as PDF, or request a quote',
    step1: 'Blade Type',
    step2: 'Dimensions',
    step3: 'Material',
    step4: 'Summary',
    selectCategory: 'Select blade type',
    selectCategoryHelp: 'Choose the type of blade you need manufactured',
    dimensionsHelp: 'Enter blade dimensions. The corresponding measurement is highlighted on the diagram.',
    specsHelp: 'Select material, coating, edge type, and tolerance specifications',
    back: 'Back',
    next: 'Next',
    resetAll: 'Reset',
    circularTitle: 'Circular Blades',
    circularDesc: 'Slitting knives, rotary cutters, scoring discs',
    straightTitle: 'Straight / Razor Blades',
    straightDesc: '3-hole, slotted, single edge, oblong blades',
    machineTitle: 'Machine Knives',
    machineDesc: 'Guillotine, granulator, shredder, logsaw, band knives',
    specialTitle: 'Special Form Blades',
    specialDesc: 'Trapezoid, hook, pentagon, arrow, scalpel, craft blades',
    packagingTitle: 'Packaging Blades',
    packagingDesc: 'Thermoform, tray mold, case sealer, sausage peeling, zig-zag',
    customTitle: 'Custom / Other',
    customDesc: 'Free-form specification for unlisted blade types',
    ...
    boltHoleCount: 'Bolt Hole Count',
    boltHoleDiameter: 'Bolt Hole Diameter',
    boltHoleSpacing: 'Bolt Hole Spacing',
    machineModel: 'Machine Brand / Model',
    ...
    approximateThickness: 'Approximate Thickness',
    usage: 'Usage',
    description: 'Description',
    subtype: 'Subtype',
    subtypeTrapezoid: 'Trapezoid',
    subtypeHook: 'Hook',
    subtypePentagon: 'Pentagon',
    subtypeArrow: 'Arrow Blade',
    subtypeScalpel: 'Scalpel / Lancet',
    subtypeCraft: 'Craft / Utility',
    subtypeThermoform: 'Thermoform / Vacuum',
    subtypeTrayMold: 'Tray Mold',
    subtypeCaseSealer: 'Case Sealer',
    subtypeSausage: 'Sausage Peeling',
    ...
    customTolerance: 'Custom Tolerance',
    edgeType: 'Edge Type',
    bevelType: 'Bevel Type',
    quantity: 'Quantity',
    notes: 'Notes',
    pcs: 'pcs',
    matCarbonSteel: 'Carbon Steel',
    matStainlessSteel: 'Stainless Steel',
    matToolSteel: 'Tool Steel',
    matHSS: 'HSS (High Speed Steel)',
    matTungstenCarbide: 'Tungsten Carbide',
    matCeramic: 'Ceramic',
    matOther: 'Other',
    coatingNone: 'No Coating',
    coatingTiN: 'TiN (Titanium Nitride)',
    coatingTiCN: 'TiCN',
    coatingTiAlN: 'TiAlN',
    coatingChrome: 'Chrome Plating',
    coatingNickel: 'Nickel Plating',
    coatingOther: 'Other',
    finishStandard: 'Standard',
    finishGround: 'Ground',
    finishPolished: 'Polished',
    finishMirror: 'Mirror Polish',
    tolStandard: 'Standard',
    tolPrecision: 'Precision',
    tolCustom: 'Custom',
    edgePlain: 'Plain (Standard)',
    edgeSerrated: 'Serrated (V-Tooth)',
    edgeWavy: 'Wavy',
    edgePerforating: 'Perforating',
    edgeScalloped: 'Scalloped',
    edgeZigzag: 'Zig-Zag',
    bevelNone: 'No Bevel',
    bevelSingle: 'Single Bevel',
    bevelDouble: 'Double Bevel',
    bevelHollow: 'Hollow Grind',
    reviewTitle: 'Specification Summary',
    reviewBladeType: 'Blade Type',
    reviewDimensions: 'Dimensions',
    reviewSpecifications: 'Material & Specifications',
    reviewQuantityNotes: 'Quantity & Notes',
    downloadPdf: 'Download PDF Spec Sheet',
    ...
    quoteMessage: 'Your Message',
    quoteSend: 'Send Quote Request',
    quoteSuccess: 'Your quote request has been received. We will get back to you shortly.',
    pdfTitle: 'BLADE SPECIFICATION SHEET',
    pdfRef: 'Ref',
    pdfDate: 'Date',
    pdfBladeType: 'BLADE TYPE',
    pdfDimensions: 'DIMENSIONS',
    pdfSpecs: 'MATERIAL & SPECIFICATIONS',
    pdfFooter: 'This is a specification request. Manufacturing drawing will be prepared upon order confirmation.',
  },
};
