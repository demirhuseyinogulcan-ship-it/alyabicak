...
const en = {
  ...
  // Blade Engineer Tool
  bladeEngineer: {
    pageTitle: 'Blade Engineer - Technical Drawing Tool',
    pageSubtitle: 'Create ISO-standard technical drawings for your industrial blades and slitter knives',
    step1: 'Geometry',
    step2: 'Dimensions',
    step3: 'Edge Profile',
    step4: 'Preview',
    step5: 'Quote',
    selectGeometry: 'Select blade geometry',
    dimensions: 'Dimensions',
    edge: 'Edge',
    mounting: 'Mounting',
    ...
    applySides: 'Apply to Sides',
    exportPdf: 'Download PDF (A4 Technical Drawing)',
    ...
    toggleCenterLines: 'Center Lines',
    back: 'Back',
    next: 'Next',
    material: 'Material',
    hardness: 'Hardness',
    ...
    circularLabel: 'Circular / Disc',
    circularDesc: 'Slitting knives, rotary cutters, scoring discs',
    rectangularLabel: 'Rectangular / Straight',
    rectangularDesc: 'Guillotine, granulator, shredder, logsaw blades',
    oblongLabel: 'Oblong / Razor',
    oblongDesc: '3-hole, slotted, injector slitting blades',
    trapezoidLabel: 'Trapezoid',
    trapezoidDesc: 'Utility, drywall and packaging blades',
    triangularLabel: 'Triangular / Pointed',
    triangularDesc: 'Plotter, CNC, scalpel, craft blades',
    hookLabel: 'Hook / Concave',
    hookDesc: 'Hook blades, cable stripping, sausage peeling',
    customLabel: 'Custom Profile',
    customDesc: 'Pentagon, star, thermoform, tray mold blades',
    outerDiameter: 'Outer Diameter',
    innerDiameter: 'Inner Diameter (Bore)',
    thickness: 'Thickness',
    bevelAngle: 'Bevel Angle',
    bevelType: 'Bevel Type',
    dishAngle: 'Dish Angle',
    length: 'Length',
    width: 'Width',
    ...
    twoHoles: '2 Holes',
    threeHoles: '3 Holes',
    cornerSquare: 'Square Corner',
    cornerRounded: 'Rounded Corner',
    cornerAngled: 'Angled Corner',
    noNotches: 'No Notches',
    oneNotch: '1 Notch',
    twoNotches: '2 Notches',
    threeNotches: '3 Notches',
    shankNone: 'No Shank',
    shankRound: 'Round Shank',
    shankFlat: 'Flat Shank',
    mountNotch: 'Notch Mount',
    mountTang: 'Tang Mount',
    mountHole: 'Hole Mount',
