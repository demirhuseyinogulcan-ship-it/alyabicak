...
const ar = {
  // Meta & SEO
  meta: {
    title: 'شفرات صناعية | سكاكين الآلات الممتازة | Alya Blade',
    description: 'مورد شفرات صناعية ممتازة. شفرات التقطيع، سكاكين الآلات، قواطع الأمان، شفرات الاستخدام العام. معتمد من FDA/USDA. خبرة أكثر من 30 عاماً. شحن عالمي.',
    keywords: 'شفرات صناعية، شفرات التقطيع، سكاكين الآلات، قواطع الأمان، شفرات شبه منحرف، شفرات كربيد التنجستن، طلاء التيتانيوم، شفرات OLFA، شفرات إعادة التدوير، شفرات FDA، الفولاذ المقاوم للصدأ، الفولاذ الكربوني، المحبب، التغليف',
  },
  ...
  hero: {
    ...
    subtitle: 'شفرات احترافية عالية الجودة',
    cta: 'استكشف المنتجات',
  ...
  categories: {
    ...
    subcategoryMetaDesc: '{{description}} {{count}} نموذج متوفر. خيارات الفولاذ الكربوني والمقاوم للصدأ وكربيد التنغستن. جودة ممتازة.',
  },
  ...
  sheffield: {
    ...
    description: 'أدوات القطع الصناعية المصنوعة من أعلى أنواع الفولاذ جودة تقلل من توقف الآلات وتزيد من كفاءة إنتاجك.',
    moreInfo: 'اعرف المزيد',
    qualityTitle: 'معايير الجودة',
    features: {
      sheffieldQuality: 'معيار جودة أليا',
      sheffieldQualityDesc: 'مواد خام عالية الجودة وتصنيع',
  ...
  durhamDuplex: {
    ...
    intro: '115 عاماً من',
    description: 'نحن الموزع في تركيا للشفرات الصناعية عالمية المستوى.',
    certifications: {
      ...
      usdaDesc: 'معتمد من وزارة الزراعة الأمريكية',
      ukTitle: 'المعيار الدولي',
      ukDesc: 'تصنيع عالمي المستوى',
    },
    cta: 'اعرف المزيد',
