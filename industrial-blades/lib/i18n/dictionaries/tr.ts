...
const tr = {
  ...
  // Blade Engineer Tool
  bladeEngineer: {
    pageTitle: 'Bıçak Mühendisi - Teknik Çizim Aracı',
    pageSubtitle: 'Endüstriyel bıçak ve jiletleriniz için ISO standartlarında teknik çizim oluşturun',
    step1: 'Geometri',
    step2: 'Boyutlar',
    step3: 'Kenar Profili',
    step4: 'Önizleme',
    step5: 'Teklif',
    selectGeometry: 'Bıçak geometrisini seçin',
    dimensions: 'Boyutlar',
    edge: 'Kenar',
    mounting: 'Montaj',
    preview: 'Önizleme ve Dışa Aktar',
    edgeType: 'Kenar Tipi',
    toothPitch: 'Diş Aralığı',
    toothDepth: 'Diş Derinliği',
    toothAngle: 'Diş Açısı',
    applySides: 'Uygulanan Kenarlar',
    exportPdf: 'PDF Olarak İndir (A4 Teknik Çizim)',
    exportPng: 'PNG Olarak İndir',
    requestQuote: 'Teklif Talebi Gönder',
    resetAll: 'Sıfırla',
    zoomIn: 'Yakınlaştır',
    zoomOut: 'Uzaklaştır',
    fitToView: 'Sığdır',
    toggleGrid: 'Izgara',
    toggleDimensions: 'Boyutlar',
    toggleCenterLines: 'Merkez Çizgileri',
    back: 'Geri',
    next: 'İleri',
    material: 'Malzeme',
    hardness: 'Sertlik',
    ...
    notes: 'Notlar',
    bladeName: 'Bıçak Adı',
    circularLabel: 'Dairesel / Disk',
    circularDesc: 'Dilme bıçakları, döner kesiciler, scoring diskleri',
    rectangularLabel: 'Dikdörtgen / Düz',
    rectangularDesc: 'Giyotin, granülatör, shredder, logsaw bıçakları',
    oblongLabel: 'Oblong / Jilet',
    oblongDesc: '3 delikli, slotted, injektör dilme jiletleri',
    trapezoidLabel: 'Trapez',
    trapezoidDesc: 'Utility, alçıpan ve paketleme bıçakları',
    triangularLabel: 'Üçgen / Sivri',
    triangularDesc: 'Plotter, CNC, bisturi, maket uçları',
    hookLabel: 'Kanca / Konkav',
    hookDesc: 'Kanca bıçaklar, kablo sıyırma, sosis sıyırma',
    customLabel: 'Özel Profil',
    customDesc: 'Beşgen, yıldız, termoform kalıp, tray bıçaklar',
    outerDiameter: 'Dış Çap',
    innerDiameter: 'İç Çap (Bore)',
    thickness: 'Kalınlık',
    bevelAngle: 'Bileme Açısı',
    bevelType: 'Bileme Tipi',
    dishAngle: 'Dish Açısı',
    length: 'Uzunluk',
    width: 'Genişlik',
    cornerRadius: 'Köşe Radyüsü',
    holeCount: 'Delik Sayısı',
    holeSpacing: 'Delik Aralığı',
    holeDiameter: 'Delik Çapı',
    hasSlot: 'Slot Var',
    cornerShape: 'Köşe Şekli',
    topWidth: 'Üst Genişlik',
    bottomWidth: 'Alt Genişlik',
    height: 'Yükseklik',
    notchCount: 'Çentik Sayısı',
    baseWidth: 'Taban Genişliği',
    tipAngle: 'Uç Açısı',
    shankType: 'Sap Tipi',
    shankDiameter: 'Sap Çapı',
    overallLength: 'Toplam Uzunluk',
    overallWidth: 'Toplam Genişlik',
    hookDepth: 'Kanca Derinliği',
    curveRadius: 'Eğrilik Radyüsü',
    hasBackEdge: 'Arka Kenar Bileme',
    mountingType: 'Montaj Tipi',
    boundingWidth: 'Sınır Genişliği',
    boundingHeight: 'Sınır Yüksekliği',
    sideCount: 'Kenar Sayısı',
    circumscribedDiameter: 'Çevrel Çap',
    centerHoleDiameter: 'Merkez Delik Çapı',
    bevelNone: 'Bileme Yok',
    bevelSingle: 'Tek Taraflı',
    bevelDouble: 'Çift Taraflı',
    bevelHollow: 'Oyma Bileme',
    noHoles: 'Delik Yok',
    twoHoles: '2 Delik',
    threeHoles: '3 Delik',
    cornerSquare: 'Kare Köşe',
    cornerRounded: 'Yuvarlak Köşe',
    cornerAngled: 'Açılı Köşe',
    noNotches: 'Çentik Yok',
    oneNotch: '1 Çentik',
    twoNotches: '2 Çentik',
    threeNotches: '3 Çentik',
    shankNone: 'Sap Yok',
    shankRound: 'Yuvarlak Sap',
    shankFlat: 'Düz Sap',
    mountNotch: 'Çentik Montaj',
    mountTang: 'Tang Montaj',
    mountHole: 'Delikli Montaj',
    edgePlain: 'Düz (Standart)',
    edgeSerrated: 'Dişli (V-Diş)',
    edgeWavy: 'Dalgalı',
    ...
    quoteCompany: 'Firma',
    quoteQuantity: 'Adet',
    quoteMessage: 'Mesajınız',
    quoteSend: 'Teklif İste',
    quoteSuccess: 'Teklif talebiniz alındı. En kısa sürede dönüş yapılacaktır.',
  },
};
