...
const tr = {
  ...
  bladeConfigurator: {
    pageTitle: 'Bicak Konfigurator',
    pageSubtitle: 'Bicak sartnamesi olusturun, PDF olarak indirin veya teklif isteyin',
    step1: 'Bicak Tipi',
    step2: 'Boyutlar',
    step3: 'Malzeme',
    step4: 'Ozet',
    selectCategory: 'Bicak tipini secin',
    selectCategoryHelp: 'Uretilmesini istediginiz bicak tipini secin',
    dimensionsHelp: 'Bicak boyutlarini girin. Diyagramda ilgili olcu vurgulanir.',
    specsHelp: 'Malzeme, kaplama, kenar tipi ve tolerans bilgilerini secin',
    back: 'Geri',
    next: 'Ileri',
    resetAll: 'Sifirla',
    // Categories
    circularTitle: 'Dairesel Bicaklar',
    circularDesc: 'Dilme bicaklari, doner kesiciler, scoring diskleri',
    straightTitle: 'Duz / Jilet Bicaklar',
    straightDesc: '3 delikli, slotted, tek kenarli, oblong jiletler',
    machineTitle: 'Makine Bicaklari',
    machineDesc: 'Giyotin, granulator, shredder, logsaw, serit bicaklar',
    specialTitle: 'Ozel Form Bicaklar',
    specialDesc: 'Trapez, kanca, besgen, ok, bisturi, maket uclari',
    packagingTitle: 'Paketleme Bicaklari',
    packagingDesc: 'Termoform, tray kalip, koli banda, sosis siyirma, zig-zag',
    customTitle: 'Ozel / Diger',
    customDesc: 'Listelenmeyenler icin serbest tanimli bicak spesifikasyonu',
    // Dimension fields
    outerDiameter: 'Dis Cap',
    innerDiameter: 'Ic Cap (Bore)',
    thickness: 'Kalinlik',
    bevelAngle: 'Bileme Acisi',
    landWidth: 'Land Genisligi',
    numberOfTeeth: 'Dis Sayisi',
    toothPitch: 'Dis Araligi',
    length: 'Uzunluk',
    width: 'Genislik',
    holeCount: 'Delik Sayisi',
    holeDiameter: 'Delik Capi',
    holeSpacing: 'Delik Araligi',
    cornerRadius: 'Kose Radyusu',
    cuttingAngle: 'Kesim Acisi',
    boltHoleCount: 'Civata Delik Sayisi',
    boltHoleDiameter: 'Civata Delik Capi',
    boltHoleSpacing: 'Civata Delik Araligi',
    machineModel: 'Makine Markasi / Modeli',
    overallLength: 'Toplam Uzunluk',
    overallWidth: 'Toplam Genislik',
    approximateLength: 'Yaklasik Uzunluk',
    approximateWidth: 'Yaklasik Genislik',
    approximateThickness: 'Yaklasik Kalinlik',
    usage: 'Kullanim Alani',
    description: 'Aciklama',
    subtype: 'Alt Tip',
    subtypeTrapezoid: 'Trapez',
    subtypeHook: 'Kanca',
    subtypePentagon: 'Besgen',
    subtypeArrow: 'Ok Bicak',
    subtypeScalpel: 'Bisturi / Nester',
    subtypeCraft: 'Maket / Falcata',
    subtypeThermoform: 'Termoform / Vakum',
    subtypeTrayMold: 'Tray (Kase) Kalip',
    subtypeCaseSealer: 'Koli Kapatma',
    subtypeSausage: 'Sosis Siyirma',
    ...
    hardness: 'Sertlik',
    coating: 'Kaplama',
    surfaceFinish: 'Yuzey Islemi',
    toleranceClass: 'Tolerans Sinifi',
    customTolerance: 'Ozel Tolerans',
    edgeType: 'Kenar Tipi',
    bevelType: 'Bileme Tipi',
    quantity: 'Adet',
    notes: 'Notlar',
    pcs: 'adet',
    matCarbonSteel: 'Karbon Celigi',
    matStainlessSteel: 'Paslanmaz Celik',
    matToolSteel: 'Takim Celigi',
    matHSS: 'HSS (Yuksek Hiz Celigi)',
    matTungstenCarbide: 'Tungsten Karbur',
    matCeramic: 'Seramik',
    matOther: 'Diger',
    coatingNone: 'Kaplama Yok',
    coatingTiN: 'TiN (Titanyum Nitrur)',
    coatingTiCN: 'TiCN',
    coatingTiAlN: 'TiAlN',
    coatingChrome: 'Krom Kaplama',
    coatingNickel: 'Nikel Kaplama',
    coatingOther: 'Diger',
    finishStandard: 'Standart',
    finishGround: 'Taslama',
    finishPolished: 'Polisaj',
    finishMirror: 'Ayna Polisaj',
    tolStandard: 'Standart',
    tolPrecision: 'Hassas',
    tolCustom: 'Ozel',
    edgePlain: 'Duz (Standart)',
    edgeSerrated: 'Disli (V-Dis)',
    edgeWavy: 'Dalgali',
    edgePerforating: 'Perfore',
    edgeScalloped: 'Tarak (Scalloped)',
    edgeZigzag: 'Zig-Zag',
    bevelNone: 'Bileme Yok',
    bevelSingle: 'Tek Tarafli',
    bevelDouble: 'Cift Tarafli',
    bevelHollow: 'Oyma Bileme',
    // Review step
    reviewTitle: 'Sartname Ozeti',
    reviewBladeType: 'Bicak Tipi',
    reviewDimensions: 'Boyutlar',
    reviewSpecifications: 'Malzeme ve Ozellikler',
    reviewQuantityNotes: 'Adet ve Notlar',
    downloadPdf: 'PDF Sartname Indir',
    requestQuote: 'Teklif Iste',
    // Quote form
    quoteTitle: 'Teklif Talebi',
    quoteName: 'Ad Soyad',
    quoteEmail: 'E-posta',
    quotePhone: 'Telefon',
    quoteCompany: 'Firma',
    quoteMessage: 'Mesajiniz',
    quoteSend: 'Teklif Iste',
    quoteSuccess: 'Teklif talebiniz alindi. En kisa surede donus yapilacaktir.',
    // PDF labels
    pdfTitle: 'BICAK SARTNAME FORMU',
    pdfRef: 'Referans',
    pdfDate: 'Tarih',
    pdfBladeType: 'BICAK TIPI',
    pdfDimensions: 'BOYUTLAR',
    pdfSpecs: 'MALZEME VE OZELLIKLER',
    pdfFooter: 'Bu bir sartname talebidir. Uretim cizimi siparis onayindan sonra hazirlanir.',
  },
};
