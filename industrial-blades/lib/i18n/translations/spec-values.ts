...
export const specValueTranslations: Record<string, Record<string, string>> = {
  ...
  tr: {
    ...
    'Yüksek kalite çelik (Yüksek Karbonlu)': 'Yüksek kalite çelik (Yüksek Karbonlu)',
    'D2 Takım Çeliği': 'D2 Takım Çeliği',
    'D2 Takım Çeliği (DIN 1.2379)': 'D2 Takım Çeliği (DIN 1.2379)',
    'HSS M2 Yüksek Hız Çeliği': 'HSS M2 Yüksek Hız Çeliği',
    ...
    'Cilalı Yüzey (Gıda Sınıfı)': 'Cilalı Yüzey (Gıda Sınıfı)',
    ...
    'Yuvarlağa göre %40 daha geniş alan': 'Yuvarlağa göre %40 daha geniş alan',
    '18-22°': '18-22°',
  ...
  en: {
    ...
    'Yuvarlağa göre %40 daha geniş alan': '40% wider area compared to round',
    '18-22°': '18-22°',
  ...
  ar: {
    ...
    'Yüksek kalite çelik (Yüksek Karbonlu)': 'فولاذ عالي الجودة (عالي الكربون)',
    'D2 Takım Çeliği': 'فولاذ أدوات D2',
    'D2 Takım Çeliği (DIN 1.2379)': 'فولاذ أدوات D2 (DIN 1.2379)',
    'HSS M2 Yüksek Hız Çeliği': 'فولاذ عالي السرعة HSS M2',
    ...
    'Kaplamasız veya TiN (Titanyum Nitrür)': 'بدون طلاء أو TiN (نيتريد التيتانيوم)',
    'Standart veya TiN PVD (2300 HV)': 'قياسي أو طلاء TiN PVD (2300 HV)',
    'Ra ≤0.4 µm (Gıda Sınıfı)': 'Ra ≤0.4 µm (درجة غذائية)',
    'Cilalı Yüzey (Gıda Sınıfı)': 'سطح مصقول (درجة غذائية)',
    ...
    'Yuvarlağa göre %40 daha geniş alan': 'أوسع بنسبة 40% مقارنة بالمستدير',
    '18-22°': '18-22°',
  ...
  fr: {
    ...
    'Yüksek kalite çelik (Yüksek Karbonlu)': 'Acier de haute qualité (Haut carbone)',
    'D2 Takım Çeliği': 'Acier d\'outillage D2',
    'D2 Takım Çeliği (DIN 1.2379)': 'Acier d\'outillage D2 (DIN 1.2379)',
    'HSS M2 Yüksek Hız Çeliği': 'Acier rapide HSS M2',
    'HSS M2 (DIN 1.3343)': 'Acier rapide HSS M2 (DIN 1.3343)',
    'AISI 440C Martensitik Paslanmaz': 'Inox martensitique AISI 440C',
    'Kaplamasız veya TiN (Titanyum Nitrür)': 'Sans revêtement ou TiN (Nitrure de Titane)',
    'Standart veya TiN PVD (2300 HV)': 'Standard ou TiN PVD (2300 HV)',
    'Ra ≤0.4 µm (Gıda Sınıfı)': 'Ra ≤0,4 µm (Qualité alimentaire)',
    'Cilalı Yüzey (Gıda Sınıfı)': 'Surface polie (Qualité alimentaire)',
    ...
    'Yuvarlağa göre %40 daha geniş alan': '40% de surface en plus par rapport au rond',
    '18-22°': '18-22°',
  ...
  ru: {
    ...
    'Yüksek kalite çelik (Yüksek Karbonlu)': 'Высококачественная сталь (высокоуглеродистая)',
    'D2 Takım Çeliği': 'Инструментальная сталь D2',
    'D2 Takım Çeliği (DIN 1.2379)': 'Инструментальная сталь D2 (DIN 1.2379)',
    'HSS M2 Yüksek Hız Çeliği': 'Быстрорежущая сталь HSS M2',
    ...
    'Kaplamasız veya TiN (Titanyum Nitrür)': 'Без покрытия или TiN (Нитрид титана)',
    'Standart veya TiN PVD (2300 HV)': 'Стандарт или TiN PVD (2300 HV)',
    'Ra ≤0.4 µm (Gıda Sınıfı)': 'Ra ≤0,4 мкм (Пищевой класс)',
    'Cilalı Yüzey (Gıda Sınıfı)': 'Полированная поверхность (Пищевой класс)',
    ...
    'Yuvarlağa göre %40 daha geniş alan': 'На 40% больше площадь чем круглый',
    '18-22°': '18-22°',
