...
<p>Toutes les lames vent cutter portent la certification CE hygiène alimentaire et sont fabriquées conformément aux réglementations européennes sur les matériaux en contact alimentaire. Adaptées aux usines certifiées HACCP, BRC et IFS.</p>`,
  ...
  'taneciklendirici': {
    ...
    description: 'Lames de granulateur pour machines de recyclage plastique. Construction en acier haute résistance à l\'usure.',
    features: ['Haute résistance à l\'usure', 'Compatible granulateur', 'Longue durée de vie'],
    applications: ['Recyclage plastique', 'Machines de granulation', 'Production de granulés'],
  },
