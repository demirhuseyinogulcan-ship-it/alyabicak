...
<p><em>NOTE : La fabrication sur mesure est disponible pour les exigences de machines et de dimensions au-delà des tailles standard indiquées dans le tableau.</em></p>`,
  ...
  'taneciklendirici': {
    name: 'Lames de Granulateur | Lames de Broyage et Recyclage Plastique',
    description: 'Lames de granulateur haute résistance à l\'usure pour machines de broyage et recyclage plastique. Options acier D2 et 2379 pour une durée de vie prolongée ; profils plats, inclinés et segmentés. Production de 100 à 600 mm de longueur, 5–40 mm d\'épaisseur.',
    features: ['Options acier D2, 2379, HSS', 'Profils plats, inclinés, segmentés', 'Montage boulonné et glissière', 'Longueur 100–600 mm', 'Épaisseur 5–40 mm', 'Fabrication sur mesure'],
    applications: ['Recyclage Plastique', 'Broyage Bouteilles & Caisses', 'Broyage Films & Plaques', 'Préparation Matières Premières'],
  },
  ...
  'granul-bicaklari': {
    name: 'Lames de Granulateur | Lames de Broyage et Recyclage Plastique',
    subtitle: 'Acier D2, 2379 (DIN 1.2379), HSS — Modèles Plats, Inclinés & Segmentés — Montage Boulonné & Glissière',
    description: 'Lames de granulateur haute résistance à l\'usure pour machines de broyage et recyclage plastique. Options acier D2 et 2379 pour une durée de vie prolongée ; profils plats, inclinés et segmentés. Production de 100 à 600 mm de longueur, 5–40 mm d\'épaisseur.',
    features: ['Options acier D2, 2379, HSS', 'Profils plats, inclinés, segmentés', 'Montage boulonné et glissière', 'Longueur 100–600 mm', 'Épaisseur 5–40 mm', 'Fabrication sur mesure'],
    benefits: [
      { title: '3 Options de Profil', description: 'Plat, incliné et segmenté — la géométrie de coupe adaptée à chaque type de machine et matériau', icon: 'Triangle' },
      { title: 'Acier D2/2379 + HSS', description: 'Dureté HRC 58–64 pour une durée de vie prolongée sur les lignes de recyclage intensif', icon: 'Shield' },
      { title: 'Dimensions Flexibles', description: 'Longueur de 100 à 600 mm, épaisseur 5–40 mm ; positions de trous personnalisées', icon: 'Ruler' },
      { title: '2 Systèmes de Montage', description: 'Montage boulonné ou glissière (canal) ; changement rapide, temps d\'arrêt minimal', icon: 'Settings' },
    ],
    applications: ['Recyclage Plastique', 'Broyage Bouteilles & Caisses', 'Broyage Films & Plaques', 'Préparation Matières Premières'],
    longDescription: `<p>Les lames de granulateur sont des éléments de coupe essentiels dans les usines de recyclage plastique, transformant les morceaux de plastique broyés en granulés. Fonctionnant en paires de lames fixes et rotatives, elles découpent le matériau à la taille souhaitée et garantissent une production de granulés homogènes.</p>\n\n<h3>Types de Profils</h3>\n<ul>\n  <li><strong>Lame Plate :</strong> Surface de coupe plate standard. Le choix le plus courant pour les lignes de broyage plastique PE, PP et PET.</li>\n  <li><strong>Lame Inclinée :</strong> Le bord de coupe incliné offre une consommation d'énergie réduite et une coupe nette par cisaillement. Idéale pour les matériaux à parois épaisses et les lignes à haute capacité.</li>\n  <li><strong>Lame Segmentée :</strong> Structure segmentée pour un montage flexible sur les machines à grandes grilles. Un segment endommagé peut être remplacé individuellement, réduisant les coûts de maintenance.</li>\n</ul>\n\n<h3>Types d'Acier</h3>\n<ul>\n  <li><strong>Acier D2 / 2379 (DIN 1.2379) :</strong> Acier de travail à froid à haute teneur en chrome, HRC 58–62. Le choix le plus populaire dans le secteur du recyclage plastique.</li>\n  <li><strong>HSS (Acier Rapide) :</strong> HRC 62–64. Aucune perte de performance avec les plastiques chargés d'abrasifs.</li>\n  <li><strong>Acier Carbone :</strong> HRC 55–58. Option économique et fiable pour les applications standard.</li>\n</ul>\n\n<p><em>NOTE : Fabrication sur mesure disponible pour les dimensions, positions de trous et profils hors gamme standard.</em></p>`,
    availableSizes: [
      '100–600 mm (longueur)',
      '5–40 mm (épaisseur)',
    ],
    seo: {
      title: 'Lames de Granulateur — Broyage & Recyclage Plastique | D2, HSS | Alya Blade',
      description: 'Lames de granulateur pour machines de broyage et recyclage plastique. Acier D2, 2379, HSS ; profils plats, inclinés et segmentés. Longueur 100–600 mm, épaisseur 5–40 mm. Fabrication sur mesure.',
      keywords: [
        'lames de granulateur', 'lame granulateur', 'lame broyage plastique',
        'lame recyclage plastique', 'couteau granulateur',
        'lame granulateur D2', 'lame granulateur HSS',
        'lame granulateur plate', 'lame granulateur inclinée', 'lame granulateur segmentée',
        'granulator blade', 'plastic recycling blade',
      ],
    },
  },
  'paralayici': {
    name: 'Lame de Broyeur — Déchiquetage Industriel',
    description: 'Lames de broyeur pour déchiquetage de plastique, papier, métal et textile. Construction en acier haute résistance aux chocs.',
    features: ['Haute résistance aux chocs', 'Compatible broyeur', 'Conditions de travail intensives'],
    applications: ['Recyclage plastique', 'Machines de déchiquetage', 'Broyage de matériaux'],
  },
  'parcalayici-bicak': {
    name: 'Lame de Broyeur — Déchiquetage Industriel',
    description: 'Lames de broyeur pour déchiquetage de plastique, papier, métal et textile. Construction en acier haute résistance aux chocs.',
