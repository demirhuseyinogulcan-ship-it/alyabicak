...
export const productsEn: Record<string, ProductTranslation> = {
  ...
  'kontr-biai': {
    ...
    description: 'Professional contour blades for thermoform and vacuum packaging machines. Compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac machines. Sheffield steel, food-grade quality.',
  ...
  'yarim': {
    ...
    description: 'Half star (triangle) punch blades for vacuum packaging and thermoform machines. Compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac. Made from D2 tool steel with high wear resistance. Titanium coating options available.',
  ...
  'tam': {
    ...
    description: 'Full star punch blades for vacuum packaging and thermoform machines. Compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac. Made from D2 tool steel with high wear resistance. Titanium coating options available.',
  ...
  'dz-biaklar': {
    ...
    description: 'Straight (lama) blades for vacuum packaging and thermoform machines. Compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac. Made from HSS (High Speed Steel), extremely durable, crush-resistant and stays sharp longer.',
  ...
  'dairesel': {
    ...
    description: 'Circular rotary blades for vacuum packaging and thermoform machines. Compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac. Sheffield steel quality.',
  ...
  'yuvarlak': {
    ...
    description: 'Round air punch blades for vacuum packaging and thermoform machines. Air hole punching compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac. Made from 440C stainless steel with high corrosion resistance, food-grade quality.',
  ...
  'oval': {
    ...
    description: 'Oval air punch blades for vacuum packaging and thermoform machines. Air hole punching compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac. Made from 440C stainless steel with high corrosion resistance, food-grade quality.',
  ...
  'dili': {
    ...
    description: 'Serrated (saw-tooth) cutting blades for vacuum packaging and thermoform machines. Compatible with Multivac, Opack, Betapak, GEA, Alcan, Ulma, Variovac. Sheffield steel, ideal for tough materials.',
