...
<p>Compatible with all major thermoform and vacuum packaging machines.</p>`,
  ...
  'taneciklendirici': {
    ...
    description: 'Granulator blades for plastic recycling granulator machines. High wear resistance steel construction.',
    features: ['High wear resistance', 'Granulator compatible', 'Long service life'],
    applications: ['Plastic recycling', 'Granulator machines', 'Granule production'],
  },
