...
<p><em>NOT: Belirtilen standart ürünler dışında farklı ölçüler bulunmaktadır. Özel ölçü talepleriniz için iletişime geçiniz.</em></p>`,
    ...
    specTable: {
      ...
      rows: [
        //  [od,  id,  th,  c,    free,  lock,  o1,    d2]
        [46,  25,  10,  8,    false, true,  true,  false],
        [50,  25,  10,  8,    false, true,  true,  false],
        ...
        [77,  60,  10,  8,    true,  false, false, true],
        [80,  60,  5,   3.5,  true,  false, false, true],
        [80,  60,  10,  8.5,  true,  false, false, true],
        [80,  60,  10,  8,    true,  false, false, true],
        [80,  60,  10,  7.5,  true,  false, false, true],
        [82,  60,  10,  8,    true,  false, false, true],
        [90,  60,  10,  8,    true,  false, false, true],
        [90,  60,  15,  12.5, false, true,  true,  false],
        [105, 60,  15,  12.5, false, true,  true,  false],
        [105, 60,  20,  17.5, false, true,  true,  false],
        [105, 80,  10,  7.5,  false, true,  true,  false],
        [105, 80,  10,  8,    true,  false, false, true],
        [105, 80,  15,  12.5, false, true,  true,  false],
        [105, 80,  20,  17.5, false, true,  true,  false],
        [105, 90,  5,   3.5,  true,  false, false, true],
        [105, 90,  10,  8,    true,  false, false, true],
        [105, 90,  19,  17,   true,  false, false, true],
        [125, 100, 18,  16,   false, true,  true,  false],
        [150, 100, 6,   null, true,  false, false, true],
        [150, 100, 10,  8,    true,  false, false, true],
        [150, 120, 10,  8,    true,  false, false, true],
        [150, 120, 15,  13,   true,  false, false, true],
      ],
