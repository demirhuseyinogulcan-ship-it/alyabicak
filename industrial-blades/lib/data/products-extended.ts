...
<p><em>NOT: Belirtilen standart ürünler dışında farklı ölçüler bulunmaktadır. Özel ölçü talepleriniz için iletişime geçiniz.</em></p>`,
    ...
    specTable: {
      columns: [
        ...
        { key: 'id', label: 'İç Çap', unit: 'mm' },
        { key: 'th', label: 'Kalınlık', unit: 'mm' },
        { key: 'c', label: 'Kesici Kalınlık', unit: 'mm' },
      ...
      rows: [
        //  [od,  id,  th,  c,    free,  lock,  o1,    d2,    hss]
        [46,  25,  10,  8,    false, true,  true,  false, false],
        [50,  25,  10,  8,    false, true,  true,  false, false],
        [60,  30,  10,  8,    false, true,  true,  false, false],
        [60,  40,  5,   3.5,  true,  false, false, true,  false],
        [60,  40,  10,  8,    true,  false, false, true,  false],
        [77,  45,  10,  8,    true,  true,  true,  true,  false],
        [77,  45,  15,  13,   false, true,  true,  false, false],
        [77,  60,  5,   3.5,  true,  false, false, true,  false],
        [77,  60,  10,  8.5,  true,  false, false, true,  false],
        [77,  60,  10,  8,    true,  false, false, true,  false],
        [80,  60,  5,   3.5,  true,  false, false, true,  false],
        [80,  60,  10,  8.5,  true,  false, false, true,  false],
        [80,  60,  10,  8,    true,  false, false, true,  false],
        [80,  60,  10,  7.5,  true,  false, false, true,  false],
        [82,  60,  10,  8,    true,  false, false, true,  false],
        [90,  60,  10,  8,    true,  false, false, true,  false],
        [90,  60,  15,  12.5, false, true,  true,  false, false],
        [105, 60,  15,  12.5, false, true,  true,  false, false],
        [105, 60,  20,  17.5, false, true,  true,  false, false],
        [105, 80,  10,  7.5,  false, true,  true,  false, false],
        [105, 80,  10,  8,    true,  false, false, true,  false],
        [105, 80,  15,  12.5, false, true,  true,  false, false],
        [105, 80,  20,  17.5, false, true,  true,  false, false],
        [105, 90,  5,   3.5,  true,  false, false, true,  false],
        [105, 90,  10,  8,    true,  false, false, true,  false],
        [105, 90,  19,  17,   true,  false, false, true,  false],
        [125, 100, 18,  16,   false, true,  true,  false, false],
        [150, 100, 6,   null, true,  false, false, true,  false],
        [150, 100, 10,  8,    true,  false, false, true,  false],
        [150, 120, 10,  8,    true,  false, false, true,  false],
        [150, 120, 15,  13,   true,  false, false, true,  false],
      ],
