...
<p><em>NOT: Belirtilen standart ürünler dışında farklı ölçüler bulunmaktadır. Özel ölçü talepleriniz için iletişime geçiniz.</em></p>`,
    ...
    specTable: {
      ...
      rows: [
        ...
        [90,  60,  1.2, true,  true,  false, true,  true],
...
<p><em>NOT: Belirtilen standart ürünler dışında farklı ölçüler bulunmaktadır. Özel ölçü talepleriniz için iletişime geçiniz.</em></p>`,
    ...
    specTable: {
      columns: [
        ...
        { key: 'id', label: 'İç Çap', unit: 'mm' },
        { key: 'th', label: 'Kalınlık', unit: 'mm' },
        { key: 'c', label: 'Kal. "C"', unit: 'mm' },
        { key: 'free', label: 'Serbest' },
        { key: 'lock', label: 'Kilitli' },
        { key: 'o1', label: 'O1' },
      ],
      columnGroups: [
        { label: 'Ölçüler', span: 4 },
        { label: 'Montaj', span: 2 },
        { label: 'Çelik', span: 1 },
      ],
      rows: [
        //  [od,  id,  th,  c,    free,  lock,  o1]
        [46,  25,  10,  8,    false, true,  true],
        [50,  25,  10,  8,    false, true,  true],
        [60,  30,  10,  8,    false, true,  true],
        [60,  40,  5,   3.5,  true,  false, true],
        [60,  40,  10,  8,    true,  false, true],
        [77,  45,  10,  8,    true,  true,  true],
        [77,  45,  15,  13,   false, true,  true],
        [77,  60,  5,   3.5,  true,  false, true],
        [77,  60,  10,  8.5,  true,  false, true],
        [77,  60,  10,  8,    true,  false, true],
        [80,  60,  5,   3.5,  true,  false, true],
        [80,  60,  10,  8.5,  true,  false, true],
        [80,  60,  10,  8,    true,  false, true],
        [80,  60,  10,  7.5,  true,  false, true],
        [82,  60,  10,  8,    true,  false, true],
        [90,  60,  10,  8,    true,  false, true],
        [90,  60,  15,  12.5, false, true,  true],
        [105, 60,  15,  12.5, false, true,  true],
        [105, 60,  20,  17.5, false, true,  true],
        [105, 80,  10,  7.5,  false, true,  true],
        [105, 80,  10,  8,    true,  false, true],
        [105, 80,  15,  12.5, false, true,  true],
        [105, 80,  20,  17.5, false, true,  true],
        [105, 90,  5,   3.5,  true,  false, true],
        [105, 90,  10,  8,    true,  false, true],
        [105, 90,  19,  17,   true,  false, true],
        [125, 100, 18,  16,   false, true,  true],
        [150, 100, 6,   null, true,  false, true],
        [150, 100, 10,  8,    true,  false, true],
        [150, 120, 10,  8,    true,  false, true],
        [150, 120, 15,  13,   true,  false, true],
      ],
      note: 'Tabloda belirtilen standart ölçüler dışında özel ölçü üretimi yapılmaktadır. Detaylı bilgi için iletişime geçiniz.',
    },
  ...
  // --- PELET BIÇAKLARI (GERİ DÖNÜŞÜM) ---
  {
    ...
    subtitle: 'D2, M2 HSS, Karbon Çelik — TiN Kaplama Opsiyonu — Su Altı Peletleme',
    categoryId: 'machine-knives',
...
<p><em>NOT: Tablodaki standart ölçüler dışında farklı makine ve boyut talepleri için özel üretim yapılmaktadır. Bileme ve yenileme hizmeti mevcuttur.</em></p>`,
    ...
    images: {
      main: {
        src: '/images/products/pelet-bicaklari.jpg',
        alt: 'Pelet Bıçağı — EREMA GALA NGR Uyumlu Peletleyici Bıçak D2 M2 HSS TiN | Alya Bıçak',
        width: 1920,
        height: 1080,
      },
      gallery: [],
    ...
    specs: [
      { label: 'material', value: 'D2 / M2 HSS / Karbon Çelik', icon: 'Layers', highlight: true },
      { label: 'hardness', value: 'HRC 58-64', icon: 'Shield', highlight: true },
      { label: 'coating', value: 'Kaplamasız veya TiN (Titanyum Nitrür)', icon: 'Sparkles' },
      { label: 'compatibility', value: 'EREMA, GALA, NGR, BKG, Econ', icon: 'Settings' },
      { label: 'cuttingType', value: 'Die Face / Su Altı Peletleme', icon: 'Droplets' },
    ],
    ...
    availableSizes: [
      '40.6×20.6×1.0mm',
      '44×20×1.0mm', '44×13×1.0mm',
      '46×24×1.0mm', '46×13×1.0mm',
    ],

    specTable: {
      columns: [
        { key: 'platform', label: 'Platform' },
        { key: 'dim', label: 'Ölçü (A×B)', unit: 'mm' },
        { key: 'th', label: 'Kalınlık', unit: 'mm' },
        { key: 'd2', label: 'D2' },
        { key: 'm2', label: 'M2 HSS' },
        { key: 'carbon', label: 'Karbon' },
        { key: 'tin', label: 'TiN Kaplama' },
      ],
      columnGroups: [
        { label: 'Makine', span: 1 },
        { label: 'Boyutlar', span: 2 },
        { label: 'Çelik / Kaplama Seçenekleri', span: 4 },
      ],
      rows: [
        ['GALA',  '40.6×20.6', 1.0, true,  true,  true,  true],
        ['EREMA', '46×24',     1.0, true,  true,  true,  true],
        ['EREMA', '46×13',     1.0, true,  true,  true,  true],
    ...
    seo: {
      ...
      keywords: [
        ...
        'BKG peletleyici bıçak', 'Econ Erema bıçak',
        'su altı peletleyici bıçağı', 'underwater pelletizer blade',
        'die face cutter', 'kalıp yüzü kesici',
        'granül bıçağı', 'granülatör bıçağı', 'plastik geri dönüşüm bıçağı',
        'D2 pelet bıçağı', 'M2 HSS peletleyici', 'TiN kaplamalı pelet bıçağı',
        '46x24 pelet bıçağı', '40x20 pelet bıçağı', '44x20 pelet bıçağı',
        'plastik peletleme bıçağı', 'pelet bıçağı üretici', 'pelet bıçağı fiyat',
        'pelletizer blades', 'pelletizer knives', 'Erema pelletizer blades',
      ],
    },
