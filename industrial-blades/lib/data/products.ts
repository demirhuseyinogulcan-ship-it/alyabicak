...
const MANUAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Plastik kırma ve geri dönüşüm makinelerinde kullanılan yüksek aşınma dirençli granül bıçakları. D2 ve 2379 takım çeliği seçenekleri ile uzun bıçak ömrü; düz, eğimli ve segmentli profiller ile her makine tipine uyum. 100 mm\'den 600 mm\'e kadar uzunluk, 5-40 mm kalınlık aralığında standart ve özel ölçü üretim.',
    categoryId: 'machine-knives',
    subcategoryId: 'recycling-knives',
    image: '/images/products/taneciklendirici-bicak.jpg',
    variants: [
      { id: 'granul-bicaklari-standard', sku: 'GRANUL-001', inStock: true },
    ],
    specifications: {
      material: 'D2 / 2379 (DIN 1.2379) / HSS',
      hardness: 'HRC 55-64',
    },
    ...
    applications: ['Plastik geri dönüşüm', 'Plastik kırma makineleri', 'Granül üretim hatları', 'Şişe ve kasa kırma'],
    isFeatured: true,
    isActive: true,
    order: 401,
  },
